          ...
          <Collapse in={showStats}>
            ...
            >
              <SimpleGrid columns={[2, 3, 6]} spacing={4}>
                ...
                <Stat size="sm">
                  <StatLabel color={termInfo}>Extended Abstracts</StatLabel>
          ...
          >
            <Flex gap={2} align="center" flexWrap="wrap">
              ...
              >
                ...
                <option value="workshop">Extended Abstracts</option>
                  ...
                  <Box flex="1" pr={2}>
                    ...
                    <Text fontSize="xs" color={termSecondary}>
                      {pub.authors.map((author, i) => {
                        ...
                        const isFirstAuthor = pub.isFirstAuthor && i === 0
                        const isCoFirstAuthor = pub.isCoFirst && pub.coFirstAuthors?.includes(cleanAuthor)
                        const shouldHighlight = isFirstAuthor || isCoFirstAuthor
