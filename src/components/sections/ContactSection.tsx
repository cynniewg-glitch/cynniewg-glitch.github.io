...
const ContactSection: React.FC = () => {
  ...
  const items = [
    ...
    siteOwner.contact.location && { icon: 'FaLocationDot', label: t('contact.location', 'Location'), value: siteOwner.contact.location },
    ...
    siteOwner.social.blog && { icon: 'TbFileCv', label: 'CV', value: 'Download CV', href: siteOwner.social.blog },
